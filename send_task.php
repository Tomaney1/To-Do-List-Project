...
if (isset($_POST['task_id']) && isset($_POST['recipient_user_id'])) {
    ...
    $sql_send_task = "INSERT INTO tasks (user_id, task_name, priority, progress, due_date) SELECT '$recipientUserId', task_name, priority, progress, due_date FROM tasks WHERE id = $taskId";
